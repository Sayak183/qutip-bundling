...
#SBATCH --output=/usr/people/roib/sayak/qutip-bundling-landau/logs/r4-mixed-%j.out
#SBATCH --error=/usr/people/roib/sayak/qutip-bundling-landau/logs/r4-mixed-%j.err
...
/usr/people/roib/sayak/qutip-bundling-landau/.conda-env/bin/python -u run_isocost_vs_dim.py --system mixed_chain --overwrite
