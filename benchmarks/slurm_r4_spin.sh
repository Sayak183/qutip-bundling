...
#SBATCH --output=/usr/people/roib/sayak/qutip-bundling-landau/logs/r4-spin-%j.out
#SBATCH --error=/usr/people/roib/sayak/qutip-bundling-landau/logs/r4-spin-%j.err
...
/usr/people/roib/sayak/qutip-bundling-landau/.conda-env/bin/python -u run_isocost_vs_dim.py --system spin_chain --overwrite
