...
| `lamb_shift_hamiltonian(L_ops, omegas, imag_gamma)` | bare $L_\alpha$ and `Im Gamma` → Lamb-shift Hamiltonian 

$$
H_{LS} = \sum_\alpha \operatorname{Im}\gamma_\alpha\, L_\alpha^\dagger L_\alpha
$$
